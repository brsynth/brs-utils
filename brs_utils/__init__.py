...
__all__ = ('total_size', 'check_nb_args',
           'file_length', 'download', 'compress_tar_gz', 'extract_gz', 'extract_tar_gz', 'extract_gz_to_string', 'download_and_extract_gz', 'download_and_extract_tar_gz', 'file_length', 'read_dict',
