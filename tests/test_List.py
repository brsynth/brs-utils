...
from brs_utils import insert_and_or_replace_in_sorted_list, diff
from brs_utils.list import flatten
...
class InsertOrReplace(TestCase):
    ...
    def test_int_from_empty(self):
        l1 = []
        l2 = insert_and_or_replace_in_sorted_list(1, l1)
        self.assertListEqual(l2, [1])

    def test_int_from_non_empty_insert_tail(self):
        l1 = [1]
        l2 = insert_and_or_replace_in_sorted_list(2, l1)
        self.assertListEqual(l2, [1, 2])
    ...
    def test_Object_new(self):
        ...
        l2 = insert_and_or_replace_in_sorted_list(obj, l1)
    ...
    def test_Object_same(self):
        ...
        l2 = insert_and_or_replace_in_sorted_list(obj, l1)
        self.assertSequenceEqual(l1, l2)
    ...
    def test_Object_existent_better(self):
        ...
        l2 = insert_and_or_replace_in_sorted_list(obj, l1)
        self.assertSequenceEqual(
            l2, [Object(2, Obj([2, 3, 5])), obj, Object(7, Obj([7, 3, 5]))]
        )
...
class Test_List(TestCase):
    ...
    def test_diff(self):
        l1 = [1, 2, 1, 3, 4]
        l2 = [1, 2, 3, 3]
        self.assertSequenceEqual(diff(l1, l2), [1, 4])

    def test_flatten(self):
        l1 = [1, 2, 3, 4, 5]
        self.assertEqual(l1, list(flatten(l1)))
        l2 = [1, [2], [3, [4, [5, 6]]]]
        self.assertEqual([1, 2, 3, 4, 5, 6], list(flatten(l2)))
        l3 = ["a", [2, {"b"}]]
        self.assertEqual(["a", 2, "b"], list(flatten(l3)))
